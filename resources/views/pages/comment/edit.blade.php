...
@section('content')
    <fieldset>
        <legend><b>COMMENT EDIT</b></legend>
        <br/>
        <form method="post">
            @csrf
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <textarea cols="30" role="5" name="comment">{{$comment->comment}}</textarea>
                    </td>
                    <td></td>
                </tr>
            </table>
            ...
            <a href="{{route('comment.list')}}" type="button" class="btn btn-primary">All Comments</a>
        </form>
    </fieldset>
@endsection
